...
function svgIcon(name) {
  const icons = {
    ...
    viper: `<img src="/icon.svg" style="width: 1em; height: 1em;" alt="Viper">`,
  };
  return icons[name] || '';
}
...
function renderNav() {
  ...
  <nav>
    <div class="nav-logo">
      <img src="/icon.svg" class="nav-logo-icon" alt="V" />
      <span>Viper</span>
...
function renderResults() {
  ...
  if (!state.results.length) {
    return `
      <div class="empty-state">
        <img src="/icon.svg" style="width: 48px; height: 48px; margin-bottom: 16px;" alt="Viper">
